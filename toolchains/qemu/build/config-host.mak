...
all:
prefix=/workspace/ece512/riscv-tools-install
bindir=${prefix}/bin
libdir=${prefix}/lib
...
VERSION=5.0.0
PKGVERSION=
SRC_PATH=/workspace/ece512/toolchains/qemu
...
QEMU_INCLUDES=-iquote $(SRC_PATH)/tcg/i386 -isystem $(SRC_PATH)/linux-headers -isystem /workspace/ece512/toolchains/qemu/build/linux-headers -iquote . -iquote $(SRC_PATH) -iquote $(SRC_PATH)/accel/tcg -iquote $(SRC_PATH)/include -iquote $(SRC_PATH)/disas/libvixl
