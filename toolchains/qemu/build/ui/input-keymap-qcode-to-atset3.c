...
const guint16 qemu_input_map_qcode_to_atset3[Q_KEY_CODE__MAX] = {
  ...
  [Q_KEY_CODE_KATAKANAHIRAGANA] = 0x87, /* qcode:Q_KEY_CODE_KATAKANAHIRAGANA (katakanahiragana) -> linux:93 (KEY_KATAKANAHIRAGANA) -> atset3:135 */
  ...
  [Q_KEY_CODE_MUHENKAN] = 0x85, /* qcode:Q_KEY_CODE_MUHENKAN (muhenkan) -> linux:94 (KEY_MUHENKAN) -> atset3:133 */
