...
const guint16 qemu_input_map_qcode_to_linux[Q_KEY_CODE__MAX] = {
  ...
  [Q_KEY_CODE_KATAKANAHIRAGANA] = 0x5d, /* qcode:Q_KEY_CODE_KATAKANAHIRAGANA (katakanahiragana) -> linux:93 (KEY_KATAKANAHIRAGANA) -> linux:93 (KEY_KATAKANAHIRAGANA) */
  ...
  [Q_KEY_CODE_MUHENKAN] = 0x5e, /* qcode:Q_KEY_CODE_MUHENKAN (muhenkan) -> linux:94 (KEY_MUHENKAN) -> linux:94 (KEY_MUHENKAN) */
