...
const guint16 qemu_input_map_qcode_to_atset2[Q_KEY_CODE__MAX] = {
  ...
  [Q_KEY_CODE_KATAKANAHIRAGANA] = 0x13, /* qcode:Q_KEY_CODE_KATAKANAHIRAGANA (katakanahiragana) -> linux:93 (KEY_KATAKANAHIRAGANA) -> atset2:19 */
  ...
  [Q_KEY_CODE_MUHENKAN] = 0x67, /* qcode:Q_KEY_CODE_MUHENKAN (muhenkan) -> linux:94 (KEY_MUHENKAN) -> atset2:103 */
