...
const guint16 qemu_input_map_qnum_to_qcode[254] = {
  ...
  [0x70] = Q_KEY_CODE_KATAKANAHIRAGANA, /* qnum:112 -> linux:93 (KEY_KATAKANAHIRAGANA) -> qcode:Q_KEY_CODE_KATAKANAHIRAGANA (katakanahiragana) */
  ...
  [0x7b] = Q_KEY_CODE_MUHENKAN, /* qnum:123 -> linux:94 (KEY_MUHENKAN) -> qcode:Q_KEY_CODE_MUHENKAN (muhenkan) */
